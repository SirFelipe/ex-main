<section id="vem_de_ex" class="conteudo">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <article>
          <header>
            <h1>Existem várias maneiras de deixar nossa cidade mais limpa.</h1>
          </header>
          <div class="img-resp row">
            ...
            <div class="col-md-6">
              <div class="conteudoTexto">
                ...
                <strong>
                  <br>
                  Para uma rua mais limpa...
                  <br>
                  Para um bairro mais limpo...
                  <br>
