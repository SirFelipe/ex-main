...
! function (t, e) {
    ...
    function kn() {
        xn.scheduled || (xn.scheduled = !0, requestAnimationFrame(xn.flush.bind(xn)))
    }
    ...
    Sn.prototype = {
        ...
        movesTo: function (t) {
            ...
            return e.right <= n.x || (e.left >= n.x ? (r[0].reverse(), r[1].reverse()) : e.bottom <= n.y ? r[0].reverse() : e.top >= n.y && r[1].reverse()), !!r.reduce(function (t, e) {
                return t + (Tn(i, e[0]) < Tn(n, e[0]) && Tn(i, e[1]) > Tn(n, e[1]))
            }, 0)
        }
    };
    var En = {};
    ...
    function An(t, e, n) {
        return En.computed(I(t) ? t.call(n, n) : t, I(e) ? e.call(n, n) : e)
    }
    ...
    function Nn(e, n, i) {
        var r = {};
        if (I(n) && (n = n.options), n.extends && (e = Nn(e, n.extends, i)), n.mixins)
            for (var t = 0, o = n.mixins.length; t < o; t++) e = Nn(e, n.mixins[t], i);
        for (var s in e) h(s);
        for (var a in n) c(e, a) || h(a);

        function h(t) {
            r[t] = (En[t] || function (t, e) {
                return H(e) ? t : e
            })(e[t], n[t], i)
        }
        return r
    ...
    En.events = En.created = En.beforeConnect = En.connected = En.beforeDisconnect = En.disconnected = En.destroy = Cn, En.args = function (t, e) {
        return !1 !== e && Cn(e || t)
    ...
    }, En.data = function (e, n, t) {
        return t ? An(e, n, t) : n ? e ? function (t) {
            return An(e, n, t)
        } : n : e
    };
    ...
    var Bn = "IntersectionObserver" in window ? window.IntersectionObserver : function () {
        function t(e, t) {
            var n = this;
            void 0 === t && (t = {});
            var i = t.rootMargin;
    ...
    var Hn, Ln, Fn, jn, Wn, Vn, Yn, Rn, qn;
    ...
    function Xn(t, e) {
        ...
        for (var s in r) {
            var a = d(s),
                h = st(o, a);
            if (!H(h)) {
                if (h = r[s] === Boolean && "" === h || Zn(r[s], h), "target" === a && (!h || w(h, "_"))) continue;
                n[s] = h
            }
        }
        var c = _n(st(o, e), i);
    ...
    Pn.util = Object.freeze({
            ...
            getCssVar: We,
            propName: Ye
        }), Pn.data = "__uikit__", Pn.prefix = "uk-", Pn.options = {}, Fn = (Hn = Pn).data, Hn.use = function (t) {
            if (!t.installed) return t.call(null, this), t.installed = !0, this
        }, Hn.mixin = function (t, e) {
            (e = (D(e) ? Hn.component(e) : e) || this).options = Nn(e.options, t)
        }, Hn.extend = function (t) {
            function e(t) {
                this._init(t)
            }
            return t = t || {}, ((e.prototype = Object.create(this.prototype)).constructor = e).options = Nn(this.options, t), e.super = this, e.extend = this.extend, e
        }, Hn.update = function (t, e) {
            (function t(e, n) {
        ...
        }, Object.defineProperty(Hn, "container", {
            get: function () {
        ...
        }), (jn = Pn).prototype._callHook = function (t) {
            var e = this,
                n = this.$options[t];
        ...
        }, Vn = 0, (Wn = Pn).prototype._init = function (t) {
            (t = t || {}).data = function (t, e) {
                ...
                if (void 0 === r && (r = {}), n = $(n) ? P(i) ? void 0 : n.slice(0, i.length).reduce(function (t, e, n) {
                    ...
                    for (var o in n) H(n[o]) ? delete n[o] : n[o] = r[o] ? Zn(r[o], n[o]) : n[o];
                return n
            }(t, this.constructor.options), this.$options = Nn(this.constructor.options, t, this), this.$el = null, this.$props = {}, this._frames = {
                reads: {},
                writes: {}
            }, this._events = [], this._uid = Vn++, this._initData(), this._initMethods(), this._initComputeds(), this._callHook("created"), t.el && this.$mount(t.el)
            ...
            var e;
            for (e in t = t || Xn(this.$options, this.$name)) H(t[e]) || (this.$props[e] = t[e]);
            var n = [this.$options.computed, this.$options.methods];
            for (e in this.$props) e in t && Jn(n, e) && (this[e] = this.$props[e])
        }, Wn.prototype._initEvents = function () {
            var n = this,
                t = this.$options.events;
            t && t.forEach(function (t) {
                if (c(t, "handler")) Gn(n, t);
                else
                    for (var e in t) Gn(n, t[e], e)
            })
        ...
        }, Rn = (Yn = Pn).data, qn = {}, Yn.component = function (s, t) {
            if (!t) return T(qn[s]) && (qn[s] = Yn.extend(qn[s])), qn[s];
            Yn[s] = function (t, n) {
                for (var e = arguments.length, i = Array(e); e--;) i[e] = arguments[e];
                var r = Yn.component(s);
                return T(t) ? new r({
                    data: t
            ...
            if (e.name = s, e.install && e.install(Yn, e, s), Yn._initialized && !e.functional) {
                var n = d(s);
                xn.read(function () {
                    return Yn[s]("[uk-" + n + "],[data-uk-" + n + "]")
                })
            }
            return qn[s] = T(t) ? e : t
        }, Yn.getComponents = function (t) {
            return t && t[Rn] || {}
        }, Yn.getComponent = function (t, e) {
            return Yn.getComponents(t)[e]
        }, Yn.connect = function (t) {
            if (t[Rn])
                for (var e in t[Rn]) t[Rn][e]._callConnected();
            for (var n = 0; n < t.attributes.length; n++) {
                var i = zn(t.attributes[n].name);
                i && i in qn && Yn[i](t)
            }
        }, Yn.disconnect = function (t) {
            for (var e in t[Rn]) t[Rn][e]._callDisconnected()
        },
        function (i) {
            var r = i.data;
    ...
    var ri, oi, si = {
        ...
        ci = {
            ...
            events: [{
                ...
                handler: function (t) {
                    jt(t) || (ri && ri !== this && ri.toggle && y(ri.toggle.mode, "hover") && !_t(t.target, ri.toggle.$el) && !et({
                        x: t.pageX,
                        y: t.pageY
                ...
                handler: function () {
                    this.tracker.init(), Bt(this.$el, "updatearia"),
                        function () {
                            if (oi) return;
                            oi = !0, Mt(document, re, function (t) {
                                var e, n = t.target,
                                    i = t.defaultPrevented;
                                if (!i)
                                    for (; ri && ri !== e && !_t(n, ri.$el) && (!ri.toggle || !_t(n, ri.toggle.$el));)(e = ri).hide(!1)
                            })
                        }()
                }
            }, {
                ...
                handler: function (t) {
                    var e = t.target;
                    this.$el === e ? (ri = this.isActive() ? null : ri, Bt(this.$el, "updatearia"), this.tracker.cancel()) : ri = null === ri && _t(e, this.$el) && this.isToggled() ? this : ri
                }
            }, {
                name: "updatearia",
                self: !0,
        ...
        di = {
            ...
            update: {
                read: function (t) {
                    ...
                    t.rows = pi(e), t.stacks = !t.rows.some(function (t) {
                        return 1 < t.length
                    })
                },
                write: function (t) {
        ...
        for (var e = [
            ...
            if (r.height)
                for (var o = e.length - 1; 0 <= o; o--) {
                    ...
                    var a = void 0;
                    if (a = s[0].offsetParent === i.offsetParent ? mi(s[0]) : (r = mi(i, !0), mi(s[0], !0)), r.top >= a.bottom - 1) {
                        e.push([i]);
                        break
                    }
                    if (r.bottom > a.top) {
    ...
    var vi = Jt ? {
        ...
        wi = {
            ...
            update: {
                read: function () {
                    return {
                        rows: (this.row ? pi(this.elements) : [this.elements]).map(bi)
                    }
                },
                write: function (t) {
    ...
    function bi(t) {
        ...
        return o && s && (He(t, "minHeight", ""), e = yi(t), i = e.heights, r = e.max), {
    ...
    var xi = {
        ...
        update: {
            read: function () {
                var t = "",
                    e = hn("height", this.$el, "content-box");
                if (this.expand) t = on(window) - (ki(document.documentElement) - ki(this.$el)) - e || "";
                else {
                    if (t = "calc(100vh", this.offsetTop) {
                        var n = en(this.$el).top;
                        t += n < on(window) / 2 ? " - " + n + "px" : ""
                    }!0 === this.offsetBottom ? t += " - " + ki(this.$el.nextElementSibling) + "px" : z(this.offsetBottom) ? t += " - " + this.offsetBottom + "vh" : this.offsetBottom && u(this.offsetBottom, "px") ? t += " - " + j(this.offsetBottom) + "px" : D(this.offsetBottom) && (t += " - " + ki(at(this.offsetBottom, this.$el)) + "px"), t += (e ? " - " + e + "px" : "") + ")"
                }
                return {
                    minHeight: t
                }
            ...
            write: function (t) {
                ...
                He(this.$el, {
                    minHeight: e
                }), this.minHeight && j(He(this.$el, "minHeight")) < this.minHeight && He(this.$el, "minHeight", this.minHeight)
            },
            events: ["resize"]
        }
    };
    ...
    var $i = {
                    ...
                    return e.applyAttributes(t), e.svgEl = function (t, e) {
                        {
                            if (Tt(e) || "CANVAS" === e.tagName) {
                                ...
                                return Ai(t, n) ? n : me(e, t)
                            }
                            var i = e.lastElementChild;
                            return Ai(t, i) ? i : fe(e, t)
                        }
                    }(t, e.$el)
                }, Q)
            },
            ...
            methods: {
                getSvg: function () {
                    ...
                    return function (n) {
                        if (Ii[n]) return Ii[n];
                        return Ii[n] = new Yt(function (e, t) {
                        ...
                        return function (t, e) {
                            e && y(t, "<symbol") && (t = function (t, e) {
                                if (!Ti[t]) {
                                    var n;
                                    for (Ti[t] = {}; n = Si.exec(t);) Ti[t][n[3]] = '<svg xmlns="http://www.w3.org/2000/svg"' + n[1] + "svg>";
                                    Si.lastIndex = 0
                                }
                                return Ti[t][e]
                            }(t, e) || t);
        ...
        _i = {
            ...
            methods: {
                getSvg: function () {
                    var t = function (t) {
                        if (!Ni[t]) return null;
                        Ci[t] || (Ci[t] = Se(Ni[t].trim()));
                        return Ci[t].cloneNode(!0)
                    }(function (t) {
    ...
    var Pi = {
        ...
        connected: function () {
            qi[this.cacheKey] ? Hi(this.$el, qi[this.cacheKey] || this.dataSrc, this.dataSrcset, this.sizes) : this.isImg && this.width && this.height && Hi(this.$el, function (t, e, n) {
                var i;
                n && (i = nt.ratio({
                    width: t,
                    height: e
                }, "width", vn(Fi(n))), t = i.width, e = i.height);
                return 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="' + t + '" height="' + e + '"></svg>'
            }(this.width, this.height, this.sizes)), this.observer = new Bn(this.load, {
        ...
        update: {
            read: function (t) {
                ...
                n && n.then(function (t) {
                    return t && "" !== t.currentSrc && Hi(e.$el, Ri(t))
                })
            },
            write: function (t) {
                if (this.dataSrcset && 1 !== window.devicePixelRatio) {
                    ...
                    !e.match(/^(auto\s?)+$/) && j(e) !== t.bgSize || (t.bgSize = function (t, e) {
                        var n = vn(Fi(e)),
                            i = (t.match(Vi) || []).map(j).sort(function (t, e) {
                                return t - e
                            });
        ...
        methods: {
            load: function (t) {
                ...
                t.some(function (t) {
                    ...
                    return Hi(e.$el, Ri(t), t.srcset, t.sizes), qi[e.cacheKey] = Ri(t), t
    ...
    var Ki, Gi, Ji = {
        ...
        Qi = {
            ...
            events: [{
                ...
                handler: function (t) {
                    var n = Ki && Ki !== this && Ki;
                    Ki = this, n ? this.stack ? this.prev = n : ((Ki = n).isToggled() ? n.hide().then(this.show) : Dt(n.$el, "beforeshow hidden", this.show, !1, function (t) {
                        var e = t.target;
                        return "hidden" === t.type && e === n.$el
                    }), t.preventDefault()) : function () {
                        if (Gi) return;
                        Gi = [Mt(document, re, function (t) {
                            var e = t.target,
                                n = t.defaultPrevented;
                            !Ki || !Ki.bgClose || n || Ki.overlay && !_t(e, Ki.$el) || _t(e, Ki.panel) || Ki.hide()
                        }), Mt(document, "keydown", function (t) {
                            27 === t.keyCode && Ki && Ki.escClose && (t.preventDefault(), Ki.hide())
                        })]
                    }()
                }
            }, {
                ...
                self: !0,
                handler: function () {
                    Ki && (Ki !== this || this.prev) || (Gi && Gi.forEach(function (t) {
                        return t()
                    }), Gi = null)
                }
            }, {
            ...
            methods: {
                ...
                show: function () {
                    ...
                    })) : this.toggleElement(this.$el, !0, tr(this))
                },
                hide: function () {
                    return this.isToggled() ? this.toggleElement(this.$el, !1, tr(this)) : Yt.resolve()
                },
                getActive: function () {
                    return Ki
                }
    ...
    var er = {
        install: function (a) {
            a.modal.dialog = function (t, e) {
                ...
                return i.show(), Mt(i.$el, "hidden", function (t) {
                    var e = t.target,
                        n = t.currentTarget;
                    e === n && Yt.resolve(function () {
                        return i.$destroy(!0)
                    })
                }), i
            ...
            update: [{
                ...
                read: function (t) {
                    ...
                    t.update && this.elements.forEach(function (t) {
                        ...
                        }), e.show = fn(t, n.offsetTop, n.offsetLeft), t._ukScrollspyState = e
                    })
                },
                write: function (r) {
                    var o = this;
        ...
        lr = {
            ...
            update: [{
                read: function (t, e) {
                    ...
                    return this.top = Math.max(j(dr("top", this)), this.topOffset) - this.offset, this.bottom = i && i - n, this.inactive = !this.matchMedia, {
                        lastScroll: !1,
                        height: n,
    ...
    Pn.version = "3.1.5", (fr = Pn).component("accordion", ei), fr.component("alert", ni), fr.component("cover", ai), fr.component("drop", ci), fr.component("dropdown", ui), fr.component("formCustom", li), fr.component("gif", di), fr.component("grid", gi), fr.component("heightMatch", wi), fr.component("heightViewport", xi), fr.component("icon", _i), fr.component("img", Pi), fr.component("leader", Ji), fr.component("margin", fi), fr.component("modal", er), fr.component("nav", nr), fr.component("navbar", ir), fr.component("offcanvas", rr), fr.component("overflowAuto", sr), fr.component("responsive", ar), fr.component("scroll", hr), fr.component("scrollspy", cr), fr.component("scrollspyNav", ur), fr.component("sticky", lr), fr.component("svg", $i), fr.component("switcher", pr), fr.component("tab", mr), fr.component("toggle", gr), fr.component("video", si), fr.component("close", Bi), fr.component("marker", Mi), fr.component("navbarToggleIcon", Mi), fr.component("overlayIcon", Mi), fr.component("paginationNext", Mi), fr.component("paginationPrevious", Mi), fr.component("searchIcon", Di), fr.component("slidenavNext", Oi), fr.component("slidenavPrevious", Oi), fr.component("spinner", zi), fr.component("totop", Mi), fr.use(ii);
    var vr = {
        mixins: [Qn],
        props: {
            date: String,
        ...
        yr = {
            ...
            methods: {
                animate: function (t) {
                    ...
                    ! function () {
                        if (wr) return;
                        (wr = fe(document.head, "<style>").sheet).insertRule("." + br + " > * {\n            margin-top: 0 !important;\n            transform: none !important;\n        }", 0)
                    }();
                    ...
                    t(), Ue.cancel(this.target), r.forEach(Ue.cancel), kr(this.target), this.$update(this.target), xn.flush();
                    var s = on(this.target),
                        a = (r = r.concat(V(this.target.children).filter(function (t) {
                            return !y(r, t)
                        }))).map(function (t, e) {
                            return !!(t.parentNode && e in o) && (o[e] ? Et(t) ? $r(t) : {
                                opacity: 0
                            } : {
                                opacity: Et(t) ? 1 : 0
                            })
                    ...
                    return o = a.map(function (t, e) {
                        var n = r[e].parentNode === i.target && (o[e] || xr(r[e]));
                        if (n)
                            if (t) {
                                if (!("opacity" in t)) {
                        ...
                        return n
                    }), Ae(this.target, br), r.forEach(function (t, e) {
                        return o[e] && He(t, o[e])
                        ...
                        }), kr(i.target), i.$update(i.target), xn.flush()
                    }, Q)
                }
            }
        };
    ...
    var Ir = {
        ...
        methods: {
            apply: function (t) {
                this.setState(Tr(t, this.attrItem, this.getState()))
            },
            getState: function () {
                var n = this;
    ...
    var Er = {
        slide: {
            ...
            translate: function (t, e) {
                return [{
                    transform: Cr(-100 * e * t)
                }, {
                    transform: Cr(100 * e * (1 - t))
                }]
            }
        }
    };
    ...
    var Br = {
                ...
                Transitioner: function (o, s, a, t) {
                    ...
                    return {
                        ...
                        show: function (t, e, n) {
                            ...
                            void 0 === e && (e = 0);
                            var r = n ? "linear" : h;
                            return t -= Math.round(t * Z(e, -1, 1)), this.translate(e), Mr(s, "itemin", {
                                percent: e,
                                duration: t,
                                timing: r,
                                dir: a
                        ...
                        translate: function (t) {
                            this.reset();
                            var e = i(t, a);
                            He(s, e[1]), He(o, e[0]), Mr(s, "itemtranslatein", {
                                percent: t,
                                dir: a
                            }), Mr(o, "itemtranslateout", {
                                percent: 1 - t,
                                dir: a
                            })
                        },
        ...
        zr = {
            ...
            events: [{
                ...
                name: "beforeitemshow",
                handler: function (t) {
                    this.isToggled() || (this.draggable = !1, t.preventDefault(), this.toggleNow(this.$el, !0), this.animation = _r.scale, Ce(t.target, this.clsActive), this.stack.splice(1, 0, this.index))
                }
            }, {
                name: "itemshow",
                handler: function (t) {
                ...
                handler: function (t, r) {
                    ...
                    if (this.setItem(r, "<span uk-spinner></span>"), e)
                        ...
                        var h = o[2],
                            c = function (t, e) {
                                return void 0 === t && (t = 640), void 0 === e && (e = 450), s.setItem(r, Pr("https://www.youtube" + (o[1] || "") + ".com/embed/" + h, t, e, s.videoAutoplay))
                            };
                        ...
                        var e = t.response,
                            n = e.height,
                            i = e.width;
                        return s.setItem(r, Pr("https://player.vimeo.com/video/" + o[2], i, n, s.videoAutoplay))
                    }, function () {
                        return s.setError(r)
                    })
                }
    ...
    var Hr, Lr = {
        install: function (t, e) {
            t.lightboxPanel || t.component("lightboxPanel", zr);
        ...
        computed: {
            ...
            items: function () {
                return J(this.toggles.map(Fr), "source")
            }
        },
        disconnected: function () {
            this.hide()
    ...
    var jr = {},
        Wr = {
            ...
            created: function () {
                jr[this.pos] || (jr[this.pos] = fe(this.$container, '<div class="uk-notification uk-notification-' + this.pos + '"></div>'));
                var t = He(jr[this.pos], "display", "block");
            ...
            methods: {
                close: function (t) {
                    function e() {
                        Bt(n.$el, "close", [n]), ve(n.$el), jr[n.pos].children.length || He(jr[n.pos], "display", "none")
                    }
                    var n = this;
    ...
    var Vr = ["x", "y", "bgx", "bgy", "rotate", "scale", "color", "backgroundColor", "borderColor", "opacity", "blur", "hue", "grayscale", "invert", "saturate", "sepia", "fopacity", "stroke"],
        Yr = {
            mixins: [Xi],
    ...
    function Xr(t, e, n) {
        ...
        return n ? i - function (t, e) {
            return Zr(e).width / 2 - Zr(t).width / 2
        }(t, e) : Math.min(i, Kr(e))
    }

    function Kr(t) {
        return Math.max(0, Gr(t) - Zr(t).width)
    }
    ...
    function Jr(t, e) {
        return (rn(t).left + (Zt ? Zr(t).width - Zr(e).width : 0)) * (Zt ? -1 : 1)
    }
    ...
    var eo = {
            ...
            data: {
                ...
                Transitioner: function (r, i, o, t) {
                    var e = t.center,
                        ...
                        a = t.list,
                        h = new Vt,
                        n = r ? Xr(r, a, e) : Xr(i, a, e) + Zr(i).width * o,
                        c = i ? Xr(i, a, e) : n + Zr(r).width * o * (Zt ? -1 : 1);
                    return {
                        dir: o,
                        show: function (t, e, n) {
                            void 0 === e && (e = 0);
                            var i = n ? "linear" : s;
                            return t -= Math.round(t * Z(e, -1, 1)), this.translate(e), r && this.updateTranslates(), e = r ? e : Z(e, 0, 1), Qr(this.getItemIn(), "itemin", {
                                percent: e,
                                duration: t,
                                timing: i,
                                dir: o
                            }), r && Qr(this.getItemIn(!0), "itemout", {
                                percent: 1 - e,
                                duration: t,
                                timing: i,
                                dir: o
                            }), Ue.start(a, {
                                transform: Cr(-c * (Zt ? -1 : 1), "px")
                        ...
                        translate: function (t) {
                            ...
                            He(a, "transform", Cr(Z(e - e * t - c, -Gr(a), Zr(a).width) * (Zt ? -1 : 1), "px")), this.updateTranslates(), r && (t = Z(t, -1, 1), Qr(this.getItemIn(), "itemtranslatein", {
                                percent: t,
                                dir: o
                            }), Qr(this.getItemIn(!0), "itemtranslateout", {
                                percent: 1 - t,
                                dir: o
                            }))
                        },
                        ...
                        getActives: function () {
                            var n = Xr(r || i, a, e);
                            return G(to(a).filter(function (t) {
                                var e = Jr(t, a);
                                return n <= e && e + Zr(t).width <= Zr(a).width + n
                            }), "offsetLeft")
                        },
                        updateTranslates: function () {
                            var n = this.getActives();
                            to(a).forEach(function (t) {
                                var e = y(n, t);
                                Qr(t, "itemtranslate" + (e ? "in" : "out"), {
                                    percent: e ? 1 : 0,
            ...
            computed: {
                avgWidth: function () {
                    return Gr(this.list) / this.length
                },
                finite: function (t) {
                    return t.finite || Gr(this.list) < Zr(this.list).width + function (t) {
                        return to(t).reduce(function (t, e) {
                ...
                maxIndex: function () {
                    ...
                    for (var t = Kr(this.list), e = this.length; e--;)
                        if (Jr(this.list.children[e], this.list) < t) return Math.min(e + 1, this.length - 1);
                    return 0
                },
                sets: function (t) {
                    var o = this,
                    ...
                    return !P(e = e && this.slides.reduce(function (t, e, n) {
                        ...
                        if (a < c + i && (!o.center && n > o.maxIndex && (n = o.maxIndex), !y(t, n))) {
                            var r = o.slides[n + 1];
                            o.center && r && i < h - Zr(r).width / 2 ? h -= i : (h = s, t.push(n), a = c + s + (o.center ? i / 2 : 0))
                        }
                        return c += i, t
                    }, [])) && e
                },
            ...
            events: {
                beforeitemshow: function (t) {
                    ...
                    if (!this.dragging && 1 < e) {
                        ...
                        t.preventDefault()
                    } else this.duration = Dr(this.avgWidth / this.velocity) * (Zr(this.dir < 0 || !this.slides[this.prevIndex] ? this.slides[this.index] : this.slides[this.prevIndex]).width / this.avgWidth), this.reorder()
                },
                itemshow: function () {
                ...
                reorder: function () {
                    ...
                    if (He(this.slides, "order", ""), !this.finite) {
                        ...
                        if (this.slides.forEach(function (t, e) {
                            ...
                            for (var t = this.slides[i], e = Zr(this.list).width / 2 - Zr(t).width / 2, r = 0; 0 < e;) {
                                var o = this.getIndex(--r + i, i),
                                    s = this.slides[o];
                                He(s, "order", i < o ? -2 : -1), e -= Zr(s).width
                            }
                    }
                },
                getValidIndex: function (t, e) {
            ...
            events: [{
                ...
                handler: function (t) {
                    var e = t.type,
                        ...
                        o = n.timing,
                        s = n.dir;
                    Ue.cancel(this.$el), He(this.$el, this.getCss(ro(e, s, i))), Ue.start(this.$el, this.getCss(io(e) ? .5 : 0 < s ? 1 : 0), r, o).catch(Q)
                }
            }, {
                ...
                handler: function (t) {
                    var e = t.type,
                        ...
                        i = n.percent,
                        r = n.dir;
                    Ue.cancel(this.$el), He(this.$el, this.getCss(ro(e, r, i)))
                }
            }]
        };
    ...
    var co, uo, lo, fo = [],
        po = {
            ...
            methods: {
                show: function () {
                    var e = this;
                    this.isActive() || (fo.forEach(function (t) {
                        return t.hide()
                    }), fo.push(this), this._unbind = Mt(document, re, function (t) {
                ...
                hide: function () {
                    !this.isActive() || bt(this.$el, "input") && this.$el === document.activeElement || (fo.splice(fo.indexOf(this), 1), clearTimeout(this.showTimer), clearInterval(this.hideTimer), it(this.$el, "aria-expanded", !1), this.toggleElement(this.tooltip, !1), this.tooltip && ve(this.tooltip), this.tooltip = !1, this._unbind())
                },
                _show: function () {
        ...
        mo = {
            ...
            events: {
                ...
                dragover: function (t) {
                    vo(t), Ae(this.$el, this.clsDragover)
                },
                dragleave: function (t) {
                    vo(t), Ce(this.$el, this.clsDragover)
                }
            },
            methods: {
                upload: function (t) {
                    ...
                    if (t.length) {
                        ...
                        for (var e = 0; e < t.length; e++) {
                            ...
                            if (this.allow && !go(this.allow, t[e].name)) return void this.fail(this.msgInvalidName.replace("%s", this.allow));
                            if (this.mime && !go(this.mime, t[e].type)) return void this.fail(this.msgInvalidMime.replace("%s", this.mime))
                        }
    ...
    function wo() {
        yo(document.body, uo), xn.flush(), new MutationObserver(function (t) {
            return t.forEach(bo)
        }).observe(document, {
            childList: !0,
            subtree: !0,
    ...
    function bo(t) {
        ...
        ("attributes" !== t.type ? function (t) {
            for (var e = t.addedNodes, n = t.removedNodes, i = 0; i < e.length; i++) yo(e[i], uo);
            for (var r = 0; r < n.length; r++) yo(n[r], lo);
            return !0
        }(t) : function (t) {
            var e = t.target,
                n = t.attributeName;
